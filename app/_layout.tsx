...
// Cache contexts replaced by Zustand stores
...
// import { useFirebaseMessaging } from "@/hooks/useFirebaseMessaging"; // [ẨN TẠM] bật lại khi dùng Dev Client / build native
...
function RootLayoutContent() {
  ...
  useSessionCheck();
  // useFirebaseMessaging(); // [ẨN TẠM] bật lại khi dùng Dev Client / build native
