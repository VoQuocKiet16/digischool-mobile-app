...
const SOCKET_URL = "https://digischool-app-374067302360.asia-southeast1.run.app/"; // Thay bằng URL backend của bạn
...
class ChatService {
  ...
  async getConversations(token: string) {
    try {
      ...
      return {
        success: false,
        message: error.response?.data?.message || "Lấy danh sách đoạn chat thất bại",
      };
    }
  }
